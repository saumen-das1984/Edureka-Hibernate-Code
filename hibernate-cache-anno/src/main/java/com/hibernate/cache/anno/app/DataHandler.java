package com.hibernate.cache.anno.app;

import java.io.IOException;

import org.hibernate.Session;

import com.hibernate.cache.anno.model.Branch;
import com.hibernate.cache.anno.util.HibernateUtil;
...
public class DataHandler {
	...
	private void populateBranches() {
		...
		try {
			...
			session.save(new Branch("TestBranch14", true));
			session.save(new Branch("TestBranch15", true));
			session.save(new Branch("TestBranch16", true));
